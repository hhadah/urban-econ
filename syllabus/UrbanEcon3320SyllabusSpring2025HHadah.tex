...
3 credit hours \\
Fall 2021\\
MWF 11:00 \AM-11:50\PM\ in GW - Goldring/Woldenberg Business Complex Room 120
\end{center}
...
\begin{tabbing}
	...
	Email: \> \href{mailto:hhadah@tulane.edu}{hhadah@tulane.edu}\\
		Room: \> The Murphy Institute, Tulane University \\ \> Caroline Richardson Building  \\ \>  62 Newcomb Place, Suite 118\\
    % Time: \\
\end{tabbing}
...
\subsection{Quizzes}
There will be four quizzes, all conducted during class time, using the entire class time. You \textbf{must be present in the classroom} to take quizzes. These are scheduled for approximately: September 19, October 17, November 14, and December 5 (dates subject to change and will be confirmed on Canvas). 

Quizzes are ``open book,'' meaning you can bring and use course notes, printed documents, books, etc., but you \textbf{cannot use any electronic devices} including laptops, tablets, or smartphones during the quiz. You cannot communicate or work with anyone else during the quiz. You will complete the quizzes using paper and pencil provided in class.

The quizzes will be approximately two or three short answer questions and zero to two multiple choice questions. 

I use your three best quizzes, which each provide 20\% of the total course grade, for a total of 60\%. This provides flexibility for those you have to miss a quiz due to illness or other circumstances - that quiz is simply dropped. However, I may be able to make arrangements for you to take the quiz at a different time depending on your circumstances, but you need to arrange this beforehand if at all possible and provide appropriate documentation.
...
\el{
@ Quiz 1 - September 17 (Wednesday)
@ Quiz 2 - October 17 (Friday)
@ Quiz 3 - November 12 (Wednesday)
@ Quiz 4 - November 21 (Friday)
...
\toprule
\textbf{Date} & \textbf{Topic / Notes} \\
\midrule
Aug.\ 18 (Mon) & Introduction to the Course \\
Aug.\ 20 (Wed) & Geographical Definitions; Scavenger Hunt \\
Aug.\ 25 (Mon) & Agglomeration, Clusters, and Cities \\
Aug.\ 29 (Fri) & Greenstone, Hornbeck, \& Moretti (2010); Intro.\ to \dots \\
\textbf{Sep.\ 1 (Mon)} & \textbf{LABOR DAY HOLIDAY (No Classes)} \\
Sep.\ 5 (Fri) & Econ.\ Development Incentives; Briefing Note assigned \\
Sep.\ 10 (Wed) & Introduction to the Economics of Crime \\
Sep.\ 15 (Mon) & Measuring the effect of police on crime \\
Sep.\ 19 (Fri) & Measuring the effect of economic circumstances on crime \\
Sep.\ 24 (Wed) & COVID-19 and Gender-Based Violence \\
Sep.\ 29 (Mon) & Racial Bias in the Criminal Justice System \\
Oct.\ 2–5 (Thu–Sun) & \textbf{FALL BREAK (No Classes)} \\
Oct.\ 8 (Wed) & Racial Bias — Group Briefing Note due / workshop \\
\bottomrule
\end{tabularx}
\end{table}
...
\toprule
\textbf{Date (Fall 2025)} & \textbf{Class Activity} \\
\midrule
Oct. 13 (Monday) & Ban the Box \\
Oct. 15 (Wednesday) & Housing Policies and Economic Theory \\
Oct. 17 (Friday) & Quiz 2 \\
Oct. 20 (Monday) & Housing Policies in Action - Metcalf (2018) \\
Oct. 22 (Wednesday) & Sexual Orientation Discrimination in Mortgages \\
Oct. 24 (Friday) & Homelessness - Family Options Study \\
Oct. 27 (Monday) & Rent Control - Theory \\
Oct. 29 (Wednesday) & Rent Control - Empirical Evidence \\
Oct. 31 (Friday) & Rent Control Briefing Note \\
Nov. 3 (Monday) & Housing Discrimination and Audit Studies \\
Nov. 5 (Wednesday) & Neighborhood Effects Introduction \\
Nov. 7 (Friday) & Moving to Opportunity Experiment \\
Nov. 10 (Monday) & Transportation and Ridesharing Research \\
Nov. 12 (Wednesday) & Quiz 3 \\
Nov. 14 (Friday) & Transportation Group Activity \\
Nov. 17 (Monday) & Review and Synthesis \\
Nov. 19 (Wednesday) & Final Review \\
Nov. 21 (Friday) & Quiz 4 \\
\textbf{Nov. 24 (Monday) to Nov. 30 (Sunday)} & \textbf{THANKSGIVING BREAK (No Classes)} \\
Dec. 1 (Monday) & Course Wrap-up and Student Presentations \\
Dec. 3 (Wednesday) & Final Discussion and Evaluations \\
\textbf{Dec. 5 (Friday)} & \textbf{LAST DAY OF CLASSES} \\
\textbf{Dec. 6-7 (Saturday-Sunday)} & \textbf{STUDY PERIOD} \\
\textbf{Dec. 8-13 (Monday-Saturday)} & \textbf{FINAL EXAM PERIOD} \\
\bottomrule
\end{tabular}
\caption{Fall 2025 Urban Economics Class Schedule (Part 2)}
\end{table}

\subsection{Artificial Intelligence (AI) Use Policy}
This course prohibits the use of artificial intelligence tools (including but not limited to ChatGPT, Claude, Bard, GPT-4, or any similar generative AI systems) for completing assignments, quizzes, or any other assessed work unless explicitly permitted by the instructor for specific assignments.

\textbf{Prohibited Uses:}
\el{
@ Using AI to write or substantially assist in writing group briefing notes
@ Using AI to answer quiz questions or prepare quiz responses  
@ Using AI to complete in-class activities or assignments
@ Using AI to analyze data or interpret research papers for coursework
@ Using AI to generate citations or reference lists
}

\textbf{Rationale:} The learning objectives of this course require you to develop critical thinking skills in economic analysis, learn to read and interpret academic research, and practice clear written communication. Using AI to complete these tasks would prevent you from achieving these learning outcomes and would constitute academic dishonesty.

\textbf{Violations:} Any use of AI tools in prohibited contexts will be treated as academic dishonesty and reported to the appropriate university authorities. If you are unsure whether a particular use of AI is permitted, please ask before using it.

\textbf{Permitted Uses:} I may explicitly allow AI use for specific activities (such as brainstorming or preliminary research), which will be clearly stated in the assignment instructions.
