...
- Fall Break (No Class on Tuesday, October 2)
...
library(renderthis)
# https://hhadah.github.io/urban-econ/slides/06-week6/01-class/gender-based-violence.html

to_pdf(from = "~/Documents/GiT/urban-econ/slides/06-week6/01-class/gender-based-violence.html", 
       to = "~/Documents/GiT/urban-econ/slides/06-week6/01-class/gender-based-violence.pdf")
to_pdf(from = "~/Documents/GiT/urban-econ/slides/06-week6/01-class/gender-based-violence.html")
```
