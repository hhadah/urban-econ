...
- We will start housing policy on Friday


---
## Next week `r top_icon("calendar-week")`

- Quiz 3 on Monday, October 20th
- Same instructions as before
- More housing!


### Readings `r icons::fontawesome("book")`

.pull-left[
- Read all of Metcalf (2018) "_Sand Castles before the Tide? Affordable Housing in Expensive Cities_"
- Skim Gyourko (1990) 
- Skim Clark and Freedman (2019)
- Skim Aaronson et. al. (2021)
]
.pull-right[
- Skim  Greenaway-McGrevy and Phillips (2023)
- Skim Song (2021)
- Skim Jarvis (2021)
- Hanlon and Heblich (2022) sections 4.4 and 4.5 only
]
...
--
### What are some possible ways of how incarceration could affect recidivism and labor market outcomes?
...
```{r, echo=FALSE, warning=FALSE, out.width="50%", fig.show='hold', fig.align='center'}

# Plot the image
grid.raster(readPNG("assets/prison.png"))
```
]
...
---
## President Obama on Ban the Box

<iframe title="APP-Embed Player" width="540" height="350" frameborder="0" scrolling="no" allowfullscreen="true" marginheight="0" marginwidth="0" src="https://uw-media.app.com/embed/video/75081184?placement=snow-embed"></iframe>
...
.pull-right[
- This table presents what their data looks like
- Callback rates are lower for Black people, slightly lower for GED compared to high school diploma, but are similar for those with and without employment gaps
...
- The coefficient gives the difference in differences estimate, which tells us if having a box differentially affects White vs Black people
...
.pull-right[
- Callback rates are similar between White and Black people with a criminal record (only disclosed when there is a box)
- White people get a 0.9 percentage point higher callback rate compared to Black people when neither has a criminal record
- **Callback rates for White people are 3.1 percentage points higher, compared to Black people, when there is no box**
]
...
- Looking at column (2), the coefficient on white shows a 4.4 percentage point higher callback rate for White people when there is no box
- The coefficient on box is not statistically significant – callback rates for White people are similar with and without the box
]
...
.pull-right[
- $Box \times white$, the coefficient of interest is -0.036, suggesting that callback rates for White people are 3.6 percentage points lower, compared to Black people, when there is a box, compared to when there is no box
...
- **Callback rates for White people are 4.5 percentage points higher, compared to Black people, when there is no box**
...
- This suggests unintended consequences, as BTB was ideally supposed to reduce employment disparities for Black people, who are more likely to have criminal records
...
- But the cost is an increase, in general, in discrimination against Black people

```{r gen_pdf, include = FALSE, cache = FALSE, eval = TRUE}
# Alternative approach using pagedown if renderthis fails
library(pagedown)
pagedown::chrome_print("~/Documents/GiT/urban-econ/slides/09-week9/01-class/incarceration-ban-box.html",
                       "~/Documents/GiT/urban-econ/slides/09-week9/01-class/incarceration-ban-box.pdf")
```
