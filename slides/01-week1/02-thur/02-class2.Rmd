...
- These data are based on three _Census_ geographical units:
...
- You will form groups with others in the classroom. Aim for groups of 2 or 3 people with at least one laptop.
  ...
  - If in person, I prefer that you submit the scavenger hunt answers using Canvas. However, if you don't have a laptop with you then I can print the questions for you and you can complete it on paper. Please led me know if you need this option. However, if using a printed copy, i'd prefer that you upload your answers to Canvas later instead of handing in the printed copy.
