...
- All the rest of the agglomeration readings (on canvas)
...
.blockquote[
###  .brand-crawfest[Census tract]

- .black[Census tracts are small, relatively permanent geographic entities within
counties (or the statistical equivalents of counties) delineated by a committee of local data users. Generally, census tracts have between 2,500 and 8,000 residents and boundaries that follow visible features.]
]

---
## 

```{r census-geo-units, echo=FALSE, warning=FALSE, out.width="60%", fig.show='hold', fig.align='center'}
# Read the image file
imgx <- readPNG("maptitude-census-summary-levels-example.png")
...
library(renderthis)
# https://hhadah.github.io/urban-econ/slides/01-week1/02-class/02-class2.html

to_pdf(from = "~/Documents/GiT/urban-econ/slides/01-week1/02-class/02-class2.html", 
       to = "~/Documents/GiT/urban-econ/slides/01-week1/02-class/02-class2.pdf")
to_pdf(from = "~/Documents/GiT/urban-econ/slides/01-week1/02-class/02-class2.html")
```
