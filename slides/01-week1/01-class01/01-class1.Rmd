...
- I like to have students interact in class, this could only happen if many of you have done the readings beforehand
...
- Tentative schedule is September 19, October 17, November 14, and December 5---tentative and subject to change

- Quiz are open book, you can bring notes, documents, etc.
...
**✅ Allowed**  
- Only if stated in instructions  
- Ex: brainstorming, prelim research  
...
- Textbook Ch. 1 to 1.3 (pdf posted on Canvas)
]

.pull-right[
- Glaeser, Kolko, Saiz - 2001

- Kerr, Robert-Nicoud - 2020]
...
library(renderthis)
# https://hhadah.github.io/urban-econ/slides/01-week1/01-class01/01-class1.html

to_pdf(from = "~/Documents/GiT/urban-econ/slides/01-week1/01-class01/01-class1.html", 
       to = "~/Documents/GiT/urban-econ/slides/01-week1/01-class01/01-class1.pdf")
to_pdf(from = "~/Documents/GiT/urban-econ/slides/01-week1/01-class01/01-class1.html")
```
