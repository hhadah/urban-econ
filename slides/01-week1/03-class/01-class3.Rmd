...
1. Agglomeration, Clusters, and Cities (cont.)

2. Practice Jigsaw

3. Greenstone, Hornbeck, & Moretti (2010)


---
## Wednesday Readings `r icons::fontawesome("book-open")`

- The readings are assigned based on the last names of the students 
...
### What are your most important reasons for living in a city?
...
- Even within cities there is a lot of concentration
  ...
  - E.g., the New York metropolitan statistical areas has a population of 20.1 million
...
# Read the image file
img1 <- readPNG("/Users/hhadah/Documents/GiT/urban-econ/slides/01-week1/03-class/Picture1.png")
...
### How can agglomeration hurt cities?

### Why do people still choose to go to cities?
...
--
- Think of a place in your daily life where businesses or people cluster. Why do you think that clustering happens?

- Give me your consumption examples that make you prefer living in a city.
...
img1 <- grid::rasterGrob(readPNG("/Users/hhadah/Documents/GiT/urban-econ/slides/01-week1/03-class/brennan.png"))
img2 <- grid::rasterGrob(readPNG("/Users/hhadah/Documents/GiT/urban-econ/slides/01-week1/03-class/the-met.png"))
img3 <- grid::rasterGrob(readPNG("/Users/hhadah/Documents/GiT/urban-econ/slides/01-week1/03-class/minute-maid-park.png"))
img4 <- grid::rasterGrob(readPNG("/Users/hhadah/Documents/GiT/urban-econ/slides/01-week1/03-class/taylor.png"))
...
img1 <- grid::rasterGrob(readPNG("/Users/hhadah/Documents/GiT/urban-econ/slides/01-week1/03-class/yellow-scale.png"))
img2 <- grid::rasterGrob(readPNG("/Users/hhadah/Documents/GiT/urban-econ/slides/01-week1/03-class/painting2.png"))
img3 <- grid::rasterGrob(readPNG("/Users/hhadah/Documents/GiT/urban-econ/slides/01-week1/03-class/panini.png"))
img4 <- grid::rasterGrob(readPNG("/Users/hhadah/Documents/GiT/urban-econ/slides/01-week1/03-class/painting3.png"))
gridExtra::grid.arrange(
  grobs = list(img1, img2, img3, img4),
  ncol = 2, nrow = 2
)
...
img1 <- grid::rasterGrob(readPNG("/Users/hhadah/Documents/GiT/urban-econ/slides/01-week1/03-class/finance-cluster.png"))
img2 <- grid::rasterGrob(readPNG("/Users/hhadah/Documents/GiT/urban-econ/slides/01-week1/03-class/barcelona.png"))
...
# Read the image file
img2 <- readPNG("/Users/hhadah/Documents/GiT/urban-econ/slides/01-week1/03-class/Picture2.png")
...
# Read the image file
img3 <- readPNG("/Users/hhadah/Documents/GiT/urban-econ/slides/01-week1/03-class/Picture3.png")
...
### What is the main question the article is trying to answer?

### Why are tech clusters important for urban economies?

### Why are tech clusters important for policy makers?
...
# Read the image file
img4 <- readPNG("/Users/hhadah/Documents/GiT/urban-econ/slides/01-week1/03-class/Picture4.png")
...
# Read the image file
img5 <- readPNG("/Users/hhadah/Documents/GiT/urban-econ/slides/01-week1/03-class/Picture5.png")
...
# Read the image file
img6 <- readPNG("/Users/hhadah/Documents/GiT/urban-econ/slides/01-week1/03-class/Picture6.png")
...
# Debate: Should cities give tax incentives to attract tech clusters?
...
library(renderthis)
# https://hhadah.github.io/urban-econ/slides/01-week1/03-class/01-class3.html

to_pdf(from = "~/Documents/GiT/urban-econ/slides/01-week1/03-class/01-class3.html", 
       to = "~/Documents/GiT/urban-econ/slides/01-week1/03-class/01-class3.pdf")
to_pdf(from = "~/Documents/GiT/urban-econ/slides/01-week1/03-class/01-class3.html")
```
