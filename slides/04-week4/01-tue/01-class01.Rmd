...
.pull-right[
```{r picture2, echo=FALSE, warning=FALSE, out.width="80%", fig.show='hold', fig.align='center'}
# Read the image file
...
.pull-right[
```{r picture3, echo=FALSE, warning=FALSE, out.width="80%", fig.show='hold', fig.align='center'}
# Read the image file
img2 <- readPNG("assets/Picture2.png")
