...
axs[0].axvline(population_mean, color='red', linestyle='dashed', linewidth=2, label=f'Mean: {population_mean:.2f}')
...
urlfile = "https://github.com/hhadah/urban-econ/blob/main/slides/03-week3/02-thur/assets/minwage_short.csv"

# Load the data
data <- read_dta(url(urlfile))
names(data)
```
