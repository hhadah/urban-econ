...
- The quiz will be 50 minutes long
 - Three short answer questions
 - Possibly one or two multiple choice questions

- Start at 11:00 am and you will need to submit the quiz by 11:50 am unless you have extra time (via Goldman)

- It will be conducted on Canvas with lockdown browser(so you will need a computer).

- It is an open book quiz but you cannot work with anyone or communicate in any way with anyone.

- You need to take the quiz in the classroom---unless you have accommodation.
...
### Quiz 2 is now on September 29th
...
- The dataset could be downloaded from [here](https://raw.githubusercontent.com/hhadah/urban-econ/main/slides/03-week3/01-class/assets/minwage_short.csv)

```{r, echo=TRUE, warning=FALSE, message=FALSE, out.width="100%", fig.show='hold', fig.align='center', eval=TRUE}
# Load the data
library(haven)
library(tidyverse)
library(dplyr)
...
urlfile = "https://raw.githubusercontent.com/hhadah/urban-econ/main/slides/03-week3/01-class/assets/minwage_short.csv"
...
library(renderthis)
# https://hhadah.github.io/urban-econ/slides/03-week3/01-class/01-class2.html

to_pdf(from = "~/Documents/GiT/urban-econ/slides/03-week3/01-class/01-class2.html", 
       to = "~/Documents/GiT/urban-econ/slides/03-week3/01-class/01-class2.pdf")
to_pdf(from = "~/Documents/GiT/urban-econ/slides/03-week3/01-class/01-class2.html")
```
