---
title: "Negative Externalities Activity"
subtitle: "Negative Externalities"
...
## This is an in-class activity on negative externalities

.pull-left[
#### Game Rules

- Multiple rounds will be played
- Each round: you receive 4 cards (2 red, 2 black)
- Card numbers don't matter
- You must give me 2 cards at the end of each round

#### Scoring
- **Black cards**: 1 point each (to you)
- **Red cards**: 0 points (to you)
- **Community benefit**: Each black card contributes to everyone's score
]

.pull-right[
#### Community Points Formula

**Community Points = (Total Black Cards Submitted) × .can-edit[X]**

Where X = **4 / (2.can-edit[N])**

- If you submit 1 black card: You get 1 + (total black cards × .can-edit[X])

#### Round Structure
1. **Round 1**: Practice round
2. **Rounds 2-3**: No communication allowed
3. **Round 4+**: Strategy discussion permitted
]

---
### Have a paper and pen ready, write your name on it and

### Keep track of the rounds 

### The paper should look like this:

- Round 1: Black cards + Community points = Total points
- Round 2: Black cards + Community points = Total points
- Round 3: Black cards + Community points = Total points
- Round 4: Black cards + Community points = Total points
- Round 5: Black cards + Community points = Total points
- Total points across all rounds

---
## Let's play the game!

### Practice round: Community points = .can-edit[X] 
### Round 1: Community points = .can-edit[X] 
### Round 2: Community points = .can-edit[X] 
### Round 3: Community points = .can-edit[X] 
### Round 4: Community points = .can-edit[X] 
### Round 5: Community points = .can-edit[X]

---
## More rounds!

### .can-edit[Round 6: Community points = .can-edit[X] ]
### .can-edit[Round 7: Community points = .can-edit[X] ]
### .can-edit[Round 8: Community points = .can-edit[X] ]
### .can-edit[Round 9: Community points = .can-edit[X] ]
### .can-edit[Round 10: Community points = .can-edit[X]]
