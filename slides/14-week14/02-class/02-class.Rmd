...
### Everyday, people spends hours stuck in traffic around the world

<br>

### It's a big problem in many US cities and even worse in other countries

<br>


### This is time that could be used for something more productive or enjoyable
.pull-left[
...
to_pdf(from = "~/Documents/GiT/urban-econ/slides/14-week14/02-class/02-class.html", 
       to = "~/Documents/GiT/urban-econ/slides/14-week14/02-class/02-class.pdf")
to_pdf(from = "~/Documents/GiT/urban-econ/slides/14-week14/02-class/02-class.html")
```
