...
.pull-right[
- Box x white, the coefficient of interest is -0.036, suggesting that callback rates for whites are 3.6 percentage points lower, compared to blacks, when there is a box, compared to when there is no box
