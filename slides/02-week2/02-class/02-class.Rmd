...
### What is the method the authors used?

### Why is it important to quantify the spillovers from agglomeration?
...
---
## We can only observe one road

```{r road-not, echo=FALSE, warning=FALSE, out.width="60%", fig.show='hold', fig.align='center'}
# Read the image file
img_road <- readPNG("assets/road-not-taken.png")

# Plot the image
grid.raster(img_road)
```
...
# Treatment points: B (0,30), A (2,50)
big_labeled_point(0, 30, "B", COLOR_TREATMENT)
big_labeled_point(2, 50, "A", COLOR_TREATMENT)

# Control points: D (0,20), C (2,30)
big_labeled_point(0, 20, "D", COLOR_CONTROL)
big_labeled_point(2, 30, "C", COLOR_CONTROL)
...
library(renderthis)
# https://hhadah.github.io/urban-econ/slides/02-week2/02-class/02-class.html

to_pdf(from = "~/Documents/GiT/urban-econ/slides/02-week2/02-class/02-class.html", 
       to = "~/Documents/GiT/urban-econ/slides/02-week2/02-class/02-class.pdf")
to_pdf(from = "~/Documents/GiT/urban-econ/slides/02-week2/02-class/02-class.html")
```
