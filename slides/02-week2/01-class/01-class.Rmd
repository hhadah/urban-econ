...
1) First grouping - "Focus Groups" - about 15 minutes
  ...
  2. While in this group, each of you will answer the first set of questions here -> Cluster Jigsaw Questions (Work on During Class Aug. 27.)
...
2) Second grouping - "Task Groups" - remaining time of about 25 minutes
  ...
  1. Your goal will be to learn enough about the other papers such that you can answer the second set of questions here -> Cluster Jigsaw Questions (Work on During Class Aug. 27)
...
library(renderthis)
# https://hhadah.github.io/urban-econ/slides/02-week2/01-class/01-class.html

to_pdf(from = "~/Documents/GiT/urban-econ/slides/02-week2/01-class/01-class.html", 
       to = "~/Documents/GiT/urban-econ/slides/02-week2/01-class/01-class.pdf")
to_pdf(from = "~/Documents/GiT/urban-econ/slides/02-week2/01-class/01-class.html")
```
